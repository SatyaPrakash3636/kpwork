...
parser.add_argument(
    'filename', help='file which contains partial (or complete) strings to search')
parser.add_argument('keepassdb', help='Path to Keepass Database file')
parser.add_argument('password', help='Password of Keepass Database file')
parser.add_argument('emailto', help='TO Email ID')
...
try:
    ...
    kp = PyKeePass(args.keepassdb, password=args.password)
except FileNotFoundError as err:
    print(f"Exception : {err}")
except Exception:
    print(f"Exception: pykeepass.exceptions.CredentialsError")
